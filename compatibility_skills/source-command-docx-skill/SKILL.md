---
name: source-command-docx-skill
description: Use when the user explicitly invokes the legacy docx-SKILL command; preserve that invocation through its maintained workflow.
---

# 舊命令 docx-SKILL

僅在使用者明確要求 `docx-SKILL` 或 `$source-command-docx-skill` 時使用；不自行攔截一般任務。
